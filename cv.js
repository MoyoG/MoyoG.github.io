...
function category(x){
	if (x == 'all-papers'){
		...
		document.getElementById('DL-papers').style.display="none";
		document.getElementById('Elder-papers').style.display = "none";
		document.getElementById('embedded-papers').style.display = "none";
	}
	if (x == 'selected-papers'){
		document.getElementById('all-papers').style.display="none";
		document.getElementById('selected-papers').style.display = "inline";
		document.getElementById('DL-papers').style.display="none";
		document.getElementById('Elder-papers').style.display = "none";
		document.getElementById('embedded-papers').style.display = "none";
	}
	if (x == 'DL+ML-papers'){
		document.getElementById('all-papers').style.display="none";
		document.getElementById('selected-papers').style.display = "none";
		document.getElementById('DL-papers').style.display="inline";
		document.getElementById('Elder-papers').style.display = "none";
		document.getElementById('embedded-papers').style.display = "none";
	}
	if (x == 'Elder-papers'){
		...
		document.getElementById('selected-papers').style.display = "none";
		document.getElementById('DL-papers').style.display="none";
		document.getElementById('Elder-papers').style.display = "inline";
		document.getElementById('embedded-papers').style.display = "none";
	}
	if (x == 'embedded-papers'){
		document.getElementById('all-papers').style.display="none";
		document.getElementById('selected-papers').style.display = "none";
		document.getElementById('DL-papers').style.display="none";
		document.getElementById('Elder-papers').style.display = "none";
		document.getElementById('embedded-papers').style.display = "inline";
	}
